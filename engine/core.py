...
class ScanContext:
    ...
    # Mode B (computer-check / SelfCheck) fields. Defaults keep Mode A unaffected.
    ...
    device_pseudonym: str = ""    # Random opaque per-install id, NOT derived from hardware
    ...
    def for_remote_target(cls, *, target_os_name: str, target_os_version: str, target_arch: str,
                          ...
                          operator_note: str = "", tags: tuple[str, ...] = ()) -> "ScanContext":
        """Build a ScanContext for a remote target (e.g. iPhone), recording the
