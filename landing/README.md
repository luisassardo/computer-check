# ComputerCheck landing page

Static ARGUS (C-LAB cyan) landing for `computercheck.c-lab.tools`. Bilingual
...
`landing/`). Map it to `computercheck.c-lab.tools` and link it from the C-LAB desk
...
- macOS: `…/releases/latest/download/ComputerCheck-macOS.dmg`
- Windows: `…/releases/latest/download/ComputerCheck-Windows-Setup.exe`
