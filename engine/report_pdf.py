...
JSON that selfcheck.py produced and that lives in the encrypted history) is read
from stdin; the PDF is written to --out.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="computer-check pdf")
